...
%DIF DEL initial_submission.tex   Thu Oct 14 02:55:06 2021
%DIF ADD main.tex                 Wed Mar 23 15:33:07 2022
...
\begin{document}
	...
	\begin{linenumbers}
		...
		\DIFaddbegin \DIFadd{When performing validation on the foreign dataset of 20 images acquired with  the Raspberry pi camera HQ, we obtained a precision 96.4\% and a recall of 92.2\%, indicating that newly available optics may largely increase segmentation performance (not shown).
		}\DIFaddend 
		...
		\DIFdelbegin \DIFdel{Random digital augmentation was applied to all images in }\DIFdelend \DIFaddbegin \DIFadd{In order to teach Mask-RCNN to account for partial insects on the edge of the pictures all images were zero-padded with a 32px margin.
