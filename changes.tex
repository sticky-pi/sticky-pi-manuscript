...
%DIF DEL revision_1.tex   Mon May  2 15:30:29 2022
%DIF ADD main.tex         Thu May 19 09:06:23 2022
...
\begin{document}
	...
	\begin{linenumbers}
		...
		\DIFaddbegin \DIFadd{The underlying data for the relevant figures are publicly available\mbox{%DIFAUXCMD
\cite{noauthor_datasets_2022}}\hskip0pt%DIFAUXCMD
.
		}\DIFaddend 
	...
	\begin{figure}[ht]
        ...
        \DIFaddbeginFL \DIFaddFL{The underlying data for this figure can be found on figshare\mbox{%DIFAUXCMD
\cite{noauthor_datasets_2022}}\hskip0pt%DIFAUXCMD
.
		}\DIFaddendFL }
		\label{fig:04}
...
.}\DIFaddendFL }
	...
	\begin{supfig}[ht]
        ...
        \DIFaddbegin \DIFadd{The underlying data for this figure can be found on figshare\mbox{%DIFAUXCMD
\cite{noauthor_datasets_2022}}\hskip0pt%DIFAUXCMD
.}\DIFaddend }
		\label{supfig:02}
	\end{supfig}
	...
	\begin{supfig}[ht]
		...
		\caption{\textbf{Temporal niches of insect taxa in a raspberry field community.} Complementary data to Fig. 6, showing all predicted taxa. Full species names are in the legend of Fig. 3 and in the result section. The low relative frequency of \emph{Drosophila suzukii} in this unbaited trial and visual inspection suggest male \emph{D. suzukii} are false positives. Other drosophilid-like flies appear to be unknown small diurnal Diptera\DIFaddbegin \DIFadd{.
        The underlying data for this figure can be found on figshare\mbox{%DIFAUXCMD
\cite{noauthor_datasets_2022}}\hskip0pt%DIFAUXCMD
}\DIFaddend .}
		\label{supfig:04}
	\end{supfig}
