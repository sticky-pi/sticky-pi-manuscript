...
\begin{document}
	...
	\begin{linenumbers}
		...
		\subsubsection*{Universal Insect Detector}
		\paragraph{Data}
		We acquired a diverse collection of 312 Sticky Pi images by, first, setting standalone sticky cards in the Vancouver area for one to two weeks and taking images with a Sticky Pi afterwards, and, second, by systematically sampling images from the field experiments. The first set of ‘offline’ images was “physically augmented” by taking photographs in variable conditions, which included illumination, presence of water droplets and thin dust particles. 
		...
		(12 images per batch) with an initial learning rate of 0.02, decaying by $\gamma=0.8$ every 10,000 iterations.
